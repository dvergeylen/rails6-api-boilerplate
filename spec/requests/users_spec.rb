...
RSpec.describe "/users", type: :request do
  ...
  let(:multiple_users_valid_attributes) {
    attributes_for_list(:user, 20)
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested user" do
        ...
        expect(user.name).to  eq(user_new_attributes[:name])
        expect(user.email).to eq(user_new_attributes[:email])
      end
